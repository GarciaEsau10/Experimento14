...
void PWM_Update(unsigned int DutyCycle)
{
    ...
    CCP2CONbits.CCP2Y = DutyCycle & 0x01;
    CCP2CONbits.CCP2X = DutyCycle & 0x02;
}
...
void main() {
    ...
    do {
        while (DutyCycle < 1023) {
            ...
            _delay((unsigned long)((10000)*(4000000/4000000.0)));
            DutyCycle += 5;

            if (DutyCycle > 1023) {
                DutyCycle = 0;
                PWM_Update(DutyCycle);
                _delay((unsigned long)((5000)*(4000000/4000000.0)));
            }
        }
    } while (1);
}
